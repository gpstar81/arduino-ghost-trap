/********************************************************
 ...
 v2.2 (Michael Rajotte) - May 2022.
 -  Added pedal light and trigger.
...
On the trap side, you can remove the wires that split into the side trap trigger switch that go to the foster connector, and instead run them to the ground rail (the ground wire) and the LED wire to pin #8 on the music maker.
